(******************************************************************************)
(*                                                                            *)
(*     Energy-balance admissibility and relativistic bremsstrahlung           *)
(*                                                                            *)
...
(* ================================================================== *)
(* === Relativistic bremsstrahlung (Bethe-Heitler) === *)
(* ================================================================== *)

(* The non-relativistic loss above uses the C_brems Z^2 n_e^2 sqrt(T)
   form. The Bethe-Heitler cross section and Maxwellian moment scaling
   below derive that sqrt(T) law and the relativistic corrections. *)
...
(* The relativistic squared-speed derivative: beta_sq'(tau) =
   2 / (1+tau)^3.  At tau = 0 this equals 2, matching the NR derivative
   beta_sq_NR'(0) = 2, so the relativistic and non-relativistic speeds
   agree to first order in tau. *)
...
(* The temperature dependence of the thermal bremsstrahlung power is
   exactly sqrt(T): P(T) = sqrt(T) P(1), inherited from the Maxwellian
   moment scaling. *)
